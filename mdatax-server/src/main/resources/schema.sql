...
CREATE TABLE IF NOT EXISTS sync_task (
    ...
    workflow_id BIGINT DEFAULT NULL COMMENT '所属工作流ID',
    ds_process_code BIGINT DEFAULT NULL COMMENT 'DolphinScheduler 流程定义编码',
    ds_schedule_id INT DEFAULT NULL COMMENT 'DolphinScheduler 定时调度ID',
    ds_task_code BIGINT DEFAULT NULL COMMENT 'DolphinScheduler 任务编码',
    schedulerx_dag_id VARCHAR(64) DEFAULT NULL COMMENT 'SchedulerX DAG ID',
