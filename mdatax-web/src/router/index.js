...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'task-board', name: 'TaskExecutionBoard', component: () => import('../views/TaskExecutionBoard.vue') },
            { path: 'tasks', name: 'TaskManagement', component: () => import('../views/TaskManagement.vue') },
